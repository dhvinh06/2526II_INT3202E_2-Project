...
const MOCK_PRODUCT = {
  id: 1, name: 'Áo thun nam basic oversize Hàn Quốc vải cotton 100% thoáng mát, thấm hút mồ hôi tốt',
      ...
      try {
        ...
        if (data && data.id) {
          setProduct({ ...MOCK_PRODUCT, ...data, id: Number(id),
            ...
            description: 'sản phẩm chất lượng' })
        } else { setProduct({ ...MOCK_PRODUCT, id: Number(id) }) }
    ...
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <section className={styles.similarSection}>
          ...
          <div className={styles.similarGrid}>{SIMILAR_PRODUCTS.map(p => <ProductCard key={p.id} product={p} />)}</div>
        </section>
      </div>
