    ...
    <header className={styles.header}>
      <div className={styles.globalNav}>
        <div className={styles.globalInner}>
          ...
          <div className={styles.globalRight}>
            ...
            <Link to="/checkout" className={`${styles.iconLink} btn-dark-utility`} aria-label="Giỏ hàng"><BagIcon /></Link>
            {user ? <button className="btn-dark-utility" onClick={handleLogout}>Đăng xuất</button>
        ...
        <div className={styles.subInner}>
          ...
          <form className={styles.searchForm} onSubmit={handleSearch}>
            ...
            <input type="text" value={search} onChange={e => setSearch(e.target.value)}
              placeholder="Tìm kiếm sản phẩm" className={`pill-input ${styles.searchInput}`} aria-label="Tìm kiếm" />
          </form>
          <div className={styles.subRight}>
            {user && <Link to="/profile" className={`${styles.greeting} t-button-utility`}>Hi, <b>{user.name.split(' ').pop()}</b></Link>}
      ...
      {menuOpen && (
        <div className={styles.mobileMenu}>
          ...
          {user ? <button className="t-dense-link" onClick={() => { handleLogout(); setMenuOpen(false) }}>Đăng xuất</button>
